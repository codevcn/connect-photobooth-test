    ...
    <div className="relative w-full h-full">
      ...
      >
        <svg
          ...
          className="w-4 h-4 smd:w-5 smd:h-5"
        >
  ...
  return (
    ...
    >
      ...
      <div className="s2xl:grid-cols-3 smd:grid-cols-2 sms:grid-cols-4 grid-cols-2 spmd:gap-2 gap-1 grid rounded-md">
        <div className="h-8 smd:h-9 mobile-touch cursor-pointer border-2 border-main-cl text-white hover:bg-white hover:text-main-cl flex items-center justify-center bg-main-cl rounded px-1 shadow">
