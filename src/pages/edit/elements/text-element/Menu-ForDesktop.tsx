  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className="5xl:py-2.5 select-none flex items-center justify-center py-1.5 cursor-move bg-gray-100 rounded-t-lg border-b border-gray-200 hover:bg-gray-200 transition"
      >
