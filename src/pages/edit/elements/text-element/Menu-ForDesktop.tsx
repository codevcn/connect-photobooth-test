...
export const TextElementMenuForDesktop = ({ elementId, onClose }: TPrintedImageMenuProps) => {
  ...
  return createPortal(
    <div
      ref={popoverRef}
      className="NAME-menu-section NAME-menu-text-element STYLE-hide-scrollbar smd:block hidden select-none fixed z-100 bg-white border-2 border-main-cl rounded-lg shadow-xl"
      style={{
