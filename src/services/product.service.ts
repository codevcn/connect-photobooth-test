      ...
      data: [
        {
          ...
          attributes_json: {},
          detail_img: [
            'https://api.encycom.com/files/1764141284848-80484747.jpg',
            'https://api.encycom.com/files/1764149678671-477028587.png',
            'https://api.encycom.com/files/1764149682691-256770195.png',
            'https://api.encycom.com/files/1764149687071-142009101.png',
            'https://api.encycom.com/files/1764149693564-654916627.png',
            'https://api.encycom.com/files/1764149701344-400365473.png',
          ],
              ...
              variant_surfaces: [
                {
                  variant_id: 21,
                  surface_id: 14,
                  mockup_url: 'https://api.encycom.com/files/1764144222158-247812660.png',
                  transform_json: {
                    x_px: 399,
                    y_px: 552,
                    scale: 10,
          ...
          surfaces: [
            {
              ...
              preview_image_url: 'https://api.encycom.com/files/1764132499796-164219352.png',
              order_index: 0,
        ...
        },
        {
          ...
          base_image_url: 'https://api.encycom.com/files/1764144222158-247812660.png',
          ...
          detail_img: [
            'http://api.encycom.com/files/1764149529586-518169392.jpeg',
            'https://api.encycom.com/files/1764146850504-440678096.png',
            'https://api.encycom.com/files/1764150352362-799195436.png',
            'https://api.encycom.com/files/1764150910348-935380858.png',
            'https://api.encycom.com/files/1764150911905-705880788.png',
          ],
        ...
        },
        {
          ...
          detail_img: ['none', 'https://api.encycom.com/files/1764140606053-419289505.png'],
          created_at: '2025-11-12T23:38:13.898Z',
          ...
          surfaces: [
            {
              ...
              preview_image_url: 'https://api.encycom.com/files/1764144222158-247812660.png',
              order_index: 1,
              created_at: '2025-11-12T23:38:13.898Z',
        ...
        },
        {
          ...
          detail_img: ['none', 'https://api.encycom.com/files/1764145988598-375074451.png'],
          created_at: '2025-11-12T23:38:13.898Z',
          updated_at: '2025-11-12T23:38:13.898Z',
          variants: [
            {
              ...
              variant_surfaces: [
                {
                  variant_id: 8,
                  surface_id: 12,
                  mockup_url: 'https://api.encycom.com/files/1764145988598-375074451.png',
                  transform_json: {},
                  zindex_json: {},
                },
              ],
          ...
          surfaces: [
            {
              ...
              code: 'front',
              display_name: 'Mặt trước',
              preview_image_url: 'https://api.encycom.com/files/1764145988598-375074451.png',
              order_index: 0,
        ...
        },
        {
          ...
          base_image_url: 'https://api.encycom.com/files/1764139393047-467619047.png',
          description: 'A ceramic mug customized via photobooth editor.',
          status: 'active',
          attributes_json: {
            category: 'mug',
          },
          detail_img: ['none', 'https://api.encycom.com/files/1764139393047-467619047.png'],
